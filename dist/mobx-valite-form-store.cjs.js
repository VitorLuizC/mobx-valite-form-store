...
prototypeAccessors.isValid.get = function () {
  return valite.isValid(this.errors);
};
...
FormStore.prototype.validateEntry = function validateEntry (entry) {
  return new Promise(function ($return, $error) {
    ...
    try {
      var error$1;
      return Promise.resolve(valite.validate(this.entries[entry], this.validators[entry])).then(function ($await_3) {
        try {
          error$1 = $await_3;
...
FormStore.prototype.validateEntries = function validateEntries () {
  return new Promise(function ($return, $error) {
    ...
    try {
      var errors;
      return Promise.resolve(valite.validateProperties(this.entries, this.validators)).then(function ($await_4) {
        try {
          errors = $await_4;
